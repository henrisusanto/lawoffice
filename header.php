...
>
	...
	<?php
	if (get_custom_option('menu_toc_home')=='yes') echo do_shortcode( '[trx_anchor id="toc_home" title="'.__('Home', 'themerex').'" description="'.__('HOME|{navigate to the home page}', 'themerex').'" icon="icon-home" separator="yes" url="'.home_url().'"]' );
	if (get_custom_option('menu_toc_top')=='yes') echo do_shortcode( '[trx_anchor id="toc_top" title="'.__('TO TOP', 'themerex').'" description="'.__('TO TOP|{scroll to top of the page}', 'themerex').'" icon="icon-up" separator="yes"]' );
	?>
				...
				<div class="topWrap" <?php echo esc_attr($header_style); ?>>
						...
						<div class="usermenu_area">
							<div class="main">
								<div class="menuUsItem menuItemRight">
									...
									?>
									<?php if ((get_custom_option('show_phone_number')=='yes') && (( $phone = get_theme_option('contact_phone')) != ''  )) { ?>
											<div class="phone_number"><?php echo esc_html($phone); ?></div>
									<?php } ?>
								</div>
					...
					<div class="mainmenu_area">
						<div class="main">
							...
							<div class="responsiveMenu"><a href="#" class="openResponsiveMenu"><?php _e('Menu', 'themerex'); ?></a></div>
