...
if (!function_exists('getBlogType')) {
	...
	global $wp_query;
		...
		if (  $page == 'blog.php')			// || is_page_template( 'blog.php' ) )
			...
			return $page;
		else if ( themerex_strpos($page, 'tribe')!==false )					// Tribe Events
			return $page;
...
if (!function_exists('getThumbSizes')) {
	function getThumbSizes($opt) {
		...
		$thumb_sizes = array(
			...
			'image_large'       => array('w' => 400, 'h' => $opt['thumb_crop'] ? 248 : null, 'h_crop' => 248),	// 400 x 248
			'masonry2'          => array('w' => 714, 'h' => $opt['thumb_crop'] ? 402 : null, 'h_crop' => 402),	// 550 x 309
			'masonry3'          => array('w' => 400, 'h' => $opt['thumb_crop'] ? 248 : null, 'h_crop' => 248),	// 350 x 217
			...
			'classic3'          => array('w' => 400, 'h' => $opt['thumb_crop'] ? 248 : null, 'h_crop' => 248),	// 350 x 217
