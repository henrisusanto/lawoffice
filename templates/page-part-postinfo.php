...
if ($show_all || in_array('more', $postinfo_buttons)) { ?>
	<li class="squareButton dark"><a title="<?php _e('More', 'themerex'); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><?php _e('More', 'themerex'); ?></a></li>
<?php
}
...
if ($show_all || in_array('views', $postinfo_buttons)) { ?>
	<li class="squareButton light ico"><a class="icon-eye" title="<?php echo sprintf(__('Views - %s', 'themerex'), $post_data['post_views']); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><?php echo esc_html($post_data['post_views']); ?></a></li>
<?php
}

if ($show_all || in_array('comments', $postinfo_buttons)) { ?>
	<li class="squareButton light ico"><a class="icon-comment-3" title="<?php echo sprintf(__('Comments - %s', 'themerex'), $post_data['post_comments']); ?>" href="<?php echo esc_url($post_data['post_comments_link']); ?>"><?php echo esc_html($post_data['post_comments']); ?></a></li>
<?php 
}
...
?>
	<li class="squareButton light ico"><a class="icon-star-1" title="<?php echo sprintf(__('Rating - %s', 'themerex'), $rating); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><?php echo ($rating); ?></a></li>
<?php
}
