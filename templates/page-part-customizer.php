									...
									<form name="co_form">
										...
										<div class="co_form_row">
											...
											<div class="co_form_subrow">
												<input type="hidden" name="co_theme_color" value="<?php echo esc_attr($theme_color); ?>" /> <!-- Main -->
												<span class="co_label one_row"><?php _e('Color 1:', 'themerex'); ?></span>
												<div id="co_theme_color" class="iColorPicker"></div>
												<input type="hidden" name="co_menu_color" value="<?php echo esc_attr($menu_color); ?>" /> <!-- Menu -->
												<span class="co_label one_row"><?php _e('Color 2:', 'themerex'); ?></span>
												<div id="co_menu_color" class="iColorPicker"></div><br/>
												<input type="hidden" name="co_user_menu_color" value="<?php echo esc_attr($user_menu_color); ?>" /> <!-- User -->
