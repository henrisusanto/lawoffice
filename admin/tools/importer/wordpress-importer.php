...
if ( class_exists( 'WP_Importer' ) ) {
	 ...
	 */
        function import( $file ) {
            ...
            @set_time_limit(max(30, min(1800, (int) get_theme_option('admin_dummy_timeout'))));
            $this->start_time = time();
            $tm = max(30, ini_get('max_execution_time'));
            $this->max_time = $tm - min(10, round($tm*0.33));	// Break import after 2/3 of time limit
	 ...
	 */
        ...
        function process_posts() {
            ...
            foreach ( $this->posts as $post ) {
                ...
                $admin_tm = max(30, min(1800, (int) get_theme_option('admin_dummy_timeout')));
