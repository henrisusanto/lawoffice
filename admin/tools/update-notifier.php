...
define( 'NOTIFIER_THEME_NAME', 'Law Office' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'lawoffice' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', themerex_get_protocol() . '://themerex.net/!updates/updates_lawoffice.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
